...
master = assemblyDiagramInit([1,1,3])([[4],[3.75],[0.2,3,0.2]])
diagram1 = assemblyDiagramInit([3,3,1])([[0.25,3.5,0.25],[1,2.5,0.25],[1]])
diagram2 = assemblyDiagramInit([1,3,1])([[1],[1,1,0.5],[1]])
diagram3 = assemblyDiagramInit([1,1,3])([[1],[1],[1,1,1]])
...
master = diagram2cell(diagram2,master,8)
master = diagram2cell(diagram3,master,10)
master = diagram2cell(diagram4,master,12)

hpc = SKEL_1(STRUCT(MKPOLS(master)))
hpc = cellNumbering (master,hpc)(range(len(master[1])),CYAN,2)
VIEW(hpc)

emptyChain = [1,5,14,16] 
...
#objExporter((verts,triangles), "../script/bathroom1.obj")
