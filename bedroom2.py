...
master = assemblyDiagramInit([1,1,3])([[6.5],[4.25],[0.2,3,0.2]])
diagram1 = assemblyDiagramInit([3,3,1])([[0.25,6,0.25],[1,3,0.25],[1]])
diagram2 = assemblyDiagramInit([1,3,1])([[1],[1.5,1,0.5],[1]])
diagram3 = assemblyDiagramInit([2,1,1])([[1,5],[1],[1]])
diagram4 = assemblyDiagramInit([1,2,1])([[1],[1,2],[1]])
diagram5 = assemblyDiagramInit([1,1,2])([[1],[1],[2,1]])
...
master = diagram2cell(diagram5,master,10)
...
#objExporter((verts,triangles), "../script/bedroom2.obj")
