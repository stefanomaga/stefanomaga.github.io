...
master = assemblyDiagramInit([1,1,3])([[2.75],[4.25],[0.2,3,0.2]])
diagram1 = assemblyDiagramInit([4,3,1])([[0.25,0.25,2,0.25],[1,3,0.25],[1]])
diagram2 = assemblyDiagramInit([1,2,1])([[1],[1.5,1.5],[1]])
diagram3 = assemblyDiagramInit([1,3,1])([[1],[1.5,1,0.5],[1]])
diagram4 = assemblyDiagramInit([1,1,2])([[1],[1],[2,1]])
diagram5 = assemblyDiagramInit([2,2,1])([[0.25,2.5],[2.5,1.75],[1]])
...
master = diagram2cell(diagram4,master,15)
master = diagram2cell(diagram5,master,0)

hpc = SKEL_1(STRUCT(MKPOLS(master)))
hpc = cellNumbering (master,hpc)(range(len(master[1])),CYAN,2)
VIEW(hpc)

emptyChain = [0,2,7,12,15,18] 
...
#objExporter((verts,triangles), "../script/bathroom2.obj")
