function makeObjects() {
	...
	objLoaderAnimated('toast', 0.01, 6.15,6.75,1.5, -Math.PI/2,0,Math.PI/2, toast1);
	objLoaderAnimated('toast', 0.01, 5.9,6.75,1.5, -Math.PI/2,0,Math.PI/2, toast2);
