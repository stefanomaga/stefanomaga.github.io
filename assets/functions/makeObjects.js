function makeObjects() {
	...
	objLoader('remote', 0.05, 12,7.5,0.5, Math.PI/2,0,Math.PI/2);
	...
	// objLoader('WEP-BumbleBee Bazooka', 0.01, 0,0,0.2, -Math.PI,Math.PI,0);
	// objLoader('WEP-BumbleBee Plasma Cannon', 0.01, 0,0,0.2, -Math.PI,Math.PI,0);
	return objects3D;
}