...
master = assemblyDiagramInit([1,1,3])([[4],[3.5],[0.2,3,0.2]])
diagram1 = assemblyDiagramInit([3,3,1])([[0.25,3.5,0.25],[0.25,3,0.25],[1]])
diagram2 = assemblyDiagramInit([1,3,1])([[1],[0.5,1,1.5],[1]])
diagram3 = assemblyDiagramInit([1,2,1])([[1],[2,1],[1]])
...
master = diagram2cell(diagram3,master,8)
...
#objExporter((verts,triangles), "../script/kitchen.obj")
