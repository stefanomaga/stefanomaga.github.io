...
master = assemblyDiagramInit([1,1,3])([[4],[5.25],[0.2,3,0.2]])
diagram1 = assemblyDiagramInit([3,3,1])([[0.25,3.5,0.25],[0.25,4,1],[1]])
diagram2 = assemblyDiagramInit([1,3,1])([[1],[1,2,1],[1]])
diagram3 = assemblyDiagramInit([1,2,1])([[1],[1,3],[1]])
...
master = diagram2cell(diagram4,master,11)
...
#objExporter((verts,triangles), "../script/bedroom1.obj")
