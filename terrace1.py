...
master = assemblyDiagramInit([1,1,3])([[2.75],[12.5],[0.2,3,0.2]])
diagram1 = assemblyDiagramInit([3,3,1])([[1,1.5,0.25],[1,10.5,1],[1]])
diagram2 = assemblyDiagramInit([1,7,1])([[1],[1,1,1.5,1,3,2,1],[1]])
diagram3 = assemblyDiagramInit([1,1,2])([[1],[1],[2,1]])
diagram4 = assemblyDiagramInit([1,1,2])([[1],[1],[1,2]])
diagram5 = assemblyDiagramInit([1,1,2])([[1],[1],[1,1]])

hpc = SKEL_1(STRUCT(MKPOLS(master)))
hpc = cellNumbering (master,hpc)(range(len(master[1])),CYAN,2)
 
master = diagram2cell(diagram1,master,1)
master = diagram2cell(diagram2,master,9)
master = diagram2cell(diagram3,master,11)
master = diagram2cell(diagram3,master,12)
master = diagram2cell(diagram3,master,13)
master = diagram2cell(diagram4,master,2)
master = diagram2cell(diagram4,master,2)
master = diagram2cell(diagram4,master,2)
master = diagram2cell(diagram4,master,2)
master = diagram2cell(diagram4,master,3)
master = diagram2cell(diagram5,master,9)

hpc = SKEL_1(STRUCT(MKPOLS(master)))
hpc = cellNumbering (master,hpc)(range(len(master[1])),CYAN,2)
VIEW(hpc)

emptyChain = [1,2,10,12,15,17,19,21,23,25] 
...
#objExporter((verts,triangles), "../script/terrace1.obj")
